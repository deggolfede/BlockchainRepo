...
function printHelp() {
  ...
  echo "    -ccep <endorsement policy> - Starting endorsement policy"
...
function deployCC() {
  ...
  scripts/deployCC.sh $CHANNEL_NAME $CC_SRC_LANGUAGE $CC_END_POLICY $VERSION $CLI_DELAY $MAX_RETRY $VERBOSE
